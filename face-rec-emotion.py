...
arastu_image = face_recognition.load_image_file("images/arastu.jpg")
arastu_face_encoding = face_recognition.face_encodings(arastu_image)[0]

prabin_image = face_recognition.load_image_file("images/prabin.jpg")
prabin_face_encoding = face_recognition.face_encodings(prabin_image)[0]

somnath_image = face_recognition.load_image_file("images/somnath.jpg")
somnath_face_encoding = face_recognition.face_encodings(somnath_image)[0]

muskan_image = face_recognition.load_image_file("images/muskan.jpg")
...
known_face_encodings = [
    ...
    trump_face_encoding,
    modi_face_encoding,
    arastu_face_encoding,
    prabin_face_encoding,
    somnath_face_encoding,
